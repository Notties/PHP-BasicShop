                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="productaddmodalLabel">Create a new Products</h5>
                            ...
                            <div class="modal-body">
                                <form method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" name="btn_insert" class="btn btn-success" value="Create Products" onClick="this.form.action='insert.php'; submit()">
                                    </div>
        ...
        <table class="table table-bordered">
            ...
            <?php
                ...
                $query = "SELECT * FROM Products WHERE ProductName 
                          LIKE '%" . $text . "%' OR Category LIKE '%" . $text . "%' OR ProductDescription LIKE '%" . $text . "%' OR ProductID LIKE '%". $text ."%'";
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="?delete_id=<?php echo $row["ProductID"]; ?>" class="confirm_delete btn btn-danger">Delete</a></td>
                    </tr>
